...
const Nav = () => {
  ...
  return (
    ...
    <div className="relative z-10 w-full h-24 px-12 bg-white flex justify-between">
      <Link href="/" to="/"><a className="block h-full flex items-center text-lg md:text-2xl font-bold tracking-widest text-black hover:text-black">Ronan O'Leary</a></Link>
