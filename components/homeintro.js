			...
			<div className="container mx-auto">
				...
				<div className="flex">
					...
					<div className="font-serif leading-loose tracking-wide text-base md:text-lg text-black opacity-50 max-w-lg md:ml-12">
						<p>I'm a versatile, experienced Web Developer, Web Product owner and currently CTO at The Next Web, with 12 years professional experience crafting websites and applications, predominantly rooted in front-end engineering, but not shy of working with back-end languages, technologies and configurations.</p>
					</div>
				</div>
			</div>
		</div>
